...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="fw-bold" style="color: var(--cedila-title);">Modifier l'Article</h3>
            ...
            <div class="row g-4">
                <div class="col-md-8">
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" class="form-control form-control-lg @error('name') is-invalid @enderror" value="{{ old('name', $menu->name) }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="number" name="price" class="form-control form-control-lg @error('price') is-invalid @enderror" value="{{ old('price', $menu->price) }}" required min="0">
                ...
                <div class="col-md-4">
                    <div class="card border border-light bg-light rounded-4 mb-4">
                        <div class="card-body">
                            ...
                            @if($menu->image_path)
                                <div class="mb-3">
                                    <img src="{{ str_starts_with($menu->image_path, 'http') ? $menu->image_path : asset('storage/'.$menu->image_path) }}" class="img-fluid rounded-3 shadow-sm" alt="{{ $menu->name }}">
                                </div>
                            @endif
